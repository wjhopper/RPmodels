---
title: SAMRL Fits to LB4L Cued Recall Subjects (Prob Params, no RI)
author: "Will Hopper"
...
model <- list(fname = 'SAMRL_sub_P_results.Rdata', modelstring = "fitSub('pS1x1',.15/(1 +.15),'pS1x2', .15/(1.2 +.15),'pS2x2', .4/(1.6 +.4),'pR',3/(3+1),'pRcor',6/(6+1),'free_params',{'pS1x1','pS1x2','pS2x2','pR','pRcor'}, 'showfigs','Off','RI',false);")
```
