...
S_two=3; % Sampling Strength after round of study practice
...
R_two=R_one; % Recovery Strength after study practice - same as after initial study i.e. no recovery learning
R_correct=10; % Recovery Strength after correct recall
...
params=[S_one S_two R_one R_correct O_two O_seven];
